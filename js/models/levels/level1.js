...
function initLevel(){
 level1 = new Levels([
    ...
    [
        ...
        new SkyBlockGroundLeft(2630, 400),  
        new SkyBlockGroundRight(2680, 400),
        new SkyBlockGroundRight (2580,300),
    ...
    [
        new WalkingGoblin(1150, 300),// 0
        new WalkingDwarf(2500, 170),// 1
